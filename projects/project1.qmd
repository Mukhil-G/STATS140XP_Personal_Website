...
author: "Mukhil Guna"
date: "2023-11-15"
image: "baseball_thumbnail.jpg" # Add an image for this project if available
---

## Project Overview

This project focuses on analyzing MLB player performance using statistical methods and interactive visualizations. The dashboard provides insights into player statistics, team performance, and predictive models for future performance.

## Key Features

- **Interactive Data Exploration**: Users can filter and analyze player statistics across different seasons
- **Performance Metrics**: Comprehensive analysis of batting averages, home runs, and other key performance indicators
- **Predictive Models**: Statistical models to predict player performance based on historical data
- **Team Comparisons**: Tools to compare statistics across different teams and seasons

## Methodology

For this project, I collected data from public MLB databases and processed it using R. The analysis pipeline includes:
...
- **baseballfunctions.R**: Custom functions for baseball-specific calculations

## Results and Insights

The analysis revealed several interesting patterns in player performance:

- Batting averages tend to stabilize after approximately 300 at-bats
- Home run rates are highly correlated with exit velocity
- Team performance is more strongly linked to pitching metrics than batting metrics
...
- Developing a machine learning component to identify undervalued players

## Code Repository

The complete code for this project is available on [GitHub](https://github.com/Mukhil-G/baseball-analytics).
